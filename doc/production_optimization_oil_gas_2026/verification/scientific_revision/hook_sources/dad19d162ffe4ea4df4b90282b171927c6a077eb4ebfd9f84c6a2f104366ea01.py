...
def after_fence(ch,fence,ns,code):
    ...
    if ch==22:
        ...
        if fence==1:
            ...
            rows.append(result('Exhaustive sampled dominance check',{'sample_count':11,'nondominated_count':len(front),'nondominated_points':front},scope='Separator liquid mass, not stock-tank oil; all points need not form a trade-off frontier.'))
        elif fence==8:
