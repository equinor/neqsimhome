...
- Figure 40: Corrected the axis to final-separator oil rate and the marker to highest sampled rate at 8 bara; final oil leaves at 1.5 bara and calculated flash temperature. Maximum sampled oil rate is 32.023 tonnes/h.
...
The subsequent Chapter 10 label correction was visually inspected by the reviewing agent at full resolution and reconciled with unchanged numerical arrays. Its refreshed image, CSV, metadata and notebook hashes are bound in the JSON ledger; the other 34 notebooks and other 103 notebook figures are unchanged.
