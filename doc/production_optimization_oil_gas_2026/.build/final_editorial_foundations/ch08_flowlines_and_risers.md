...
![Figure 8.2: Pressure and temperature profiles along a 20 km subsea flowline for different pipe diameters](figures/pipeline_pt_profiles.png)
...
![Figure 8.3: Illustrative seabed and riser elevation profile relative to sea level](figures/flowline_riser_profile.png)
...
![Figure 8.4: Pressure Drop vs Pipeline Diameter (Flow = 50 t/hr, L = 10 km, horizontal)](figures/fig01_pressure_drop_vs_diameter.png)
...
![Figure 8.5: Pressure Drop vs Flow Rate (Diameter = 8 inch, L = 10 km, horizontal)](figures/fig02_pressure_drop_vs_flow.png)
...
![Figure 8.6: Liquid Holdup vs Gas Velocity (8-inch pipe, 5 km, horizontal)](figures/fig03_liquid_holdup.png)
...
![Figure 8.7: Pipeline Capacity Curve (Available ΔP = 20 bar, L = 10 km)](figures/fig04_pipeline_capacity.png)
