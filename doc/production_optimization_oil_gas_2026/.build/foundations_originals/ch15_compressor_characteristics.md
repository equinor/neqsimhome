...
**Exercise 13.3**: A compressor designed for a gas with MW = 22 and $\gamma = 1.28$ is now operating with a leaner gas (MW = 18, $\gamma = 1.32$) due to reservoir depletion. At the same speed:
...
**Exercise 13.5**: Implement a simple field performance monitoring tool in Python that:
...
**Exercise 13.6**: Design an anti-surge system for the compressor in Exercise 13.1. Determine:
...
**Exercise 13.8**: Compare the polytropic head and power calculated by NeqSim (using the SRK equation of state) with ideal gas calculations for:
...
**Exercise 13.10**: A platform has three compressor trains in parallel, each rated at 10 MW. Production requires a total compression power of 25 MW. Evaluate the optimal operating strategy:
