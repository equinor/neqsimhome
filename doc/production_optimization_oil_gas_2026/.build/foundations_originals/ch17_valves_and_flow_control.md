...
![Control valve inherent characteristics: linear, equal percentage, and quick opening](figures/valve_characteristics_curves.png)
...
**Exercise 15.1 — Control Valve Sizing**
...
**Exercise 15.2 — JT Cooling Study**
...
**Exercise 15.3 — Production Choke Optimization**
...
**Exercise 15.5 — Valve Characteristic Comparison**
...
**Exercise 15.6 — Integrated System Pressure Balance**
...
![Figure 17.1: Cv And Jt Vs Flow](figures/ch15_cv_and_jt_vs_flow.png)

*Figure 17.1: Cv And Jt Vs Flow*

![Figure 17.2: Jt Cooling Vs Dp](figures/ch15_jt_cooling_vs_dp.png)

*Figure 17.2: Jt Cooling Vs Dp*

![Figure 17.3: Pt Path](figures/ch15_pt_path.png)

*Figure 17.3: Pt Path*

![Figure 17.4: Valve Opening](figures/ch15_valve_opening.png)
