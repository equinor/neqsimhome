...
![Individual Well Rates vs Manifold Pressure. NeqSim WellFlow inflow-only model](figures/ch27_manifold_pressure_sweep.png)
...
![Well A — Choke Sensitivity. Inflow sensitivity to an assumed additional pressure loss](figures/ch27_choke_sensitivity.png)
