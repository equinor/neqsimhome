...
![Flow patterns in vertical upward multiphase flow](figures/flow_patterns_vertical.png)
...
![Pressure traverse curves for different tubing flow rates](figures/pressure_traverse.png)
...
![Gas lift performance curve showing optimum injection rate](figures/gas_lift_performance.png)
...
![Log-log diagnostic plot showing wellbore storage, radial flow, and boundary effects](figures/log_log_diagnostic.png)
...
![VFP curves showing bottomhole pressure vs. flow rate at different wellhead pressures](figures/vfp_curves.png)
...
![Nodal analysis showing intersection of IPR and VFP curves to determine the operating point](figures/nodal_analysis.png)
...
![Illustrative gas-lift response model. Illustrative analytical gas-lift response, not a NeqSim well simulation](figures/ch05_fig03_gas_lift_optimization.png)
