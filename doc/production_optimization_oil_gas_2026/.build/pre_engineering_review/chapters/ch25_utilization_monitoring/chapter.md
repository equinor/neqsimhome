...
![Typical utilization profiles for a separator and compressor over a 20-year field life, showing the plateau, decline, and late-life water handling phases.](figures/fig26_1_utilization_profiles.png)
...
![The four-layer utilization monitoring architecture: sensor data acquisition, process model execution, constraint evaluation, and dashboard presentation.](figures/fig26_2_monitoring_architecture.png)
...
![Integrated utilization heatmap for a production platform over 12 months, showing seasonal variation in compressor utilization and progressive increase in separator liquid handling utilization due to rising water cut.](figures/fig26_3_utilization_heatmap.png)
...
- **Optimizer-in-the-loop:** Run the `ProductionOptimizer` (Chapter 25) periodically and push the optimized setpoints to the DCS.
...
![Compressor power utilization across operating rates. NeqSim stage powers divided by assumed ratings](figures/ch26_utilization_heatmap.png)
...
![Bottleneck Transition Analysis. Fixed-composition NeqSim compression sensitivity](figures/ch26_bottleneck_transition.png)
