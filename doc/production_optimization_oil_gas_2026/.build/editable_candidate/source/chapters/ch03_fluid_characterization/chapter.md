...
$$
\frac{n_g}{n_o} = \text{GOR}\,\frac{P^{\text{sc}}M_o}{Z^{\text{sc}} R T^{\text{sc}}\rho_o^{\text{sc}}}
$$
...
![Molecular Weight Distribution of Gas Condensate Components. Input characterization and component molecular weights](figures/fig01_molecular_weight_distribution.png)
