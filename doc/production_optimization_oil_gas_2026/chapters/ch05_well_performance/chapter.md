...
![Figure 5.2: Analytical gas-lift illustration with an explicit marginal cost-equivalent assumption](figures/gas_lift_performance.png)
...
![Figure 5.3: Log-log diagnostic plot showing wellbore storage, radial flow, and boundary effects](figures/log_log_diagnostic.png)
...
![Figure 5.4: Illustrative pressure-rate curves at four assumed wellhead pressures](figures/vfp_curves.png)
...
![Figure 5.5: Illustrative nodal intersection for specified inflow and outflow curves](figures/nodal_analysis.png)
...
![Figure 5.6: Vertical Lift Performance (VLP) Curves - Different Tubing Sizes](figures/ch05_fig01_vlp_curves.png)
...
![Figure 5.7: Coupled operating point](figures/ch05_fig02_operating_point.png)
...
![Figure 5.8: Illustrative gas-lift response model. Illustrative analytical gas-lift response, not a NeqSim well simulation](figures/ch05_fig03_gas_lift_optimization.png)
...
![Figure 5.9: Wellhead Pressure vs Flow Rate at Different Water Mole Fractions](figures/ch05_fig04_watercut_effect.png)
