...
Untranslated cubic equations of state can have substantial systematic liquid-density errors; their magnitude depends on fluid, temperature and pressure and must be benchmarked for the application. **Volume translation** corrects this by shifting the molar volume:
...
$$
\left|1+\Delta t\,\lambda_j\right|<1\quad\text{for every decaying linear mode }j
$$
...
![Figure 31.1: TP Flash Computation Time vs Pressure. Observed timings and NeqSim gas-labelled phase fraction; the high-pressure single-phase classification is not a critical-point determination](figures/ch29_flash_convergence.png)
...
![Figure 31.2: Effect of Initial Temperature Guess. Observed timings from this execution environment](figures/ch29_initial_guess_effect.png)
...
![Figure 31.3: Recycle Loop Convergence — Direct Substitution](figures/ch29_recycle_convergence.png)
...
![Figure 31.4: Flash Computation Time vs Number of Components. Observed timings from this execution environment](figures/ch29_component_scaling.png)
