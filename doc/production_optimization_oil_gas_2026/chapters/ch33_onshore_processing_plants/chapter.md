...
Section 33.10 specifies the dry-hydrocarbon feed and the operating assumptions for this diagram's four-product calculation boundary.
...
The worked model represents precooling as an external cooler, provides a knockout before the expander and accounts for its liquid bypass. It credits no gas-gas heat recovery or automatic shaft coupling.
