...
#block(sticky: true)[#strong[Tool-backed calculation]]
...
#block(sticky: true)[#strong[Missing-data stop rule]]
...
#block(sticky: true)[#strong[Source-aware document extraction]]
...
#block(sticky: true)[#strong[Safety boundary]]
