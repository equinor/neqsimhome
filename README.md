...
## NeqSimLive 
NeqSimLive is a collection of APIs used for simulation and condition monitoring of process plants. Support on developing digital twin components for flow assurance, process and transport can be reqested from the [Energy and Process Technology group](https://www.ntnu.no/ansatte/even.solbraa) at NTNU.
