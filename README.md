...
The NeqSim library is written in the Java programming language. The sources and pre-compiled java libraries can be downloaded from [the NeqSim Java reprository](https://github.com/equinor/neqsim)
